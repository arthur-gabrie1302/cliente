...
def novo_cliente(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return HttpResponse('<h1> Deu erro no teu formulario<h1>')
...
def atualizar_cliente(request, id):
    try:
        ...
        return HttpResponse('<h1>Cliente não aencontrado</h1>')
...
def excluir_cliente(request, id):
    ...
    #return HttpResponse("<h1> Aqui vai ser o formulario de novo Cliente")